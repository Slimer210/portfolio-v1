...
export default function Navigation() {
    return (
        <nav className='fixed top-0 md:top-6 items-center self-center z-50'>
          <div className='self-center w-content bg-white bg-opacity-40 backdrop-blur-lg shadow-lg rounded-2xl p-3 gap-x-0 md:gap-x-2 flex font-bold text-black text-opacity-80 text-md md:text-lg'>
